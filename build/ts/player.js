  ...
  (function (Remoting) {
    (function (Player) {
      ...
      var PlayerChannelSerializer = (function () {
        ...
        PlayerChannelSerializer.prototype.writeNetStream = function (netStream) {
        ...
        PlayerChannelSerializer.prototype.writeUpdateFrame = function (displayObject) {
          ...
          var hasMiscellaneousProperties = displayObject._hasFlags(536870912 /* DirtyMiscellaneousProperties */);
      ...
      Player.prototype.processEventUpdates = function (updates) {
        ...
        switch ((event.kind)) {
          ...
          case 1 /* Mouse */:
            ...
            var target = this._mouseEventDispatcher.handleMouseEvent(event);
