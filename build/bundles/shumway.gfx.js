...
(function (Shumway) {
  (function (GFX) {
    ...
    var RenderableVideo = (function (_super) {
      ...
      function RenderableVideo(url, bounds) {
        _super.call(this, bounds);
      ...
      RenderableVideo.prototype.invalidatePaintCheck = function () {
      ...
      RenderableVideo.invalidateVideos = function () {
      ...
      RenderableVideo.prototype.render = function (context, cullBounds) {
